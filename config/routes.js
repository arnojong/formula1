...
module.exports.routes = {
  ...
  'GET /list/filter':        'PostController.filter',
  'GET /list':               'PostController.viewAll',
  'GET /banhammer':          'UserController.viewUsers',
  'GET /delete/:id':         'UserController.ban',
  ...
  'POST /post/comment/:id':      'CommentController.create',
